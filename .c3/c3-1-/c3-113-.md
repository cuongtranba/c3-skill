---
id: c3-113
c3-seal: d6d1f57349b5cecd02baf575d19958a969a5f3e3defcd524a64400bc14ea8ea2
title: lifecycle-cmds
type: component
parent: c3-1
goal: 'Keep the `.c3/` store and its canonical markdown coherent across its lifecycle: import a tree into the database, export and sync it back out, repair drift, run the status migration, delete an entity safely, and install Git guardrails.'
uses:
